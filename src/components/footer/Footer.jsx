...
const Footer = () => {
  return (
    <footer className="py-16 bg-gray-300 px-4">
      <section className="">
        <div className="flex flex-row gap-8 sm:gap-0 justify-between px-3 md:px-4 lg:px-16 flex-wrap">
          <div className="hidden sm:flex justify-center items-center">
            <Link to="/" className="text-2xl md:text-3xl font-medium text-gray-800">E-Buy</Link>
          </div>

          <div className="flex flex-col">
            <h2 className="md:text-lg text-gray-800 font-medium">About</h2>
